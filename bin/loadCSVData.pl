...
take a CSV file and load a database table with the data.
...
purge the table before loading


=item 'prefix:s'

use a generated prefixed table name based on this prefix
...
This file was automatically generated from the file: loadCSVData.pl.m80 by
