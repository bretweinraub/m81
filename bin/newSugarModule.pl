...
my $sugarDir;
$sugarDir = $ENV{sugarDir} if $ENV{sugarDir};
my $module;
...
GetOptions( 	'sugarDir:s'	=> \$sugarDir,
	'module:s'	=> \$module,
	'trace'	=> \$trace,
	'debug+'	=> \$debug,
	'help'	=> \$help,
...
print_usage() if $help;
unless ($sugarDir) { Warn "sugarDir is required" ; print_usage() ; } 
...
=item [REQUIRED] 'sugarDir:s'

namespace for this sugar implementation
...
This file was automatically generated from the file: newSugarModule.pl.m80 by
