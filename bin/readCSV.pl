...
print_usage() if $help;
unless ($field) { Warn "field is required" ; print_usage() ; } 
unless ($table) { Warn "table is required" ; print_usage() ; } 
...
=item [REQUIRED] 'field:s'

field to analyze


=item [REQUIRED] 'table:s'
