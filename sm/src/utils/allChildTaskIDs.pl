...
my $master_task_id;
$master_task_id = $ENV{master_task_id} if $ENV{master_task_id};
$trace = "0";
...
GetOptions( 	'master_task_id:i'	=> \$master_task_id,
	'trace'	=> \$trace,
	'debug+'	=> \$debug,
	'help'	=> \$help,
 );
...
print_usage() if $help;
unless ($master_task_id) { Warn "master_task_id is required" ; print_usage() ; } 

=pod

=head1 NAME

allChildTaskIDs.pl.m80.pl    

=head1 SYNOPSIS

print a list of child task ids for this master_task_id
...
=item [REQUIRED] 'master_task_id:i'

The master_task_id that is used as the root for deriving all related child tasks.
...
This file was automatically generated from the file: allChildTaskIDs.pl.m80 by
