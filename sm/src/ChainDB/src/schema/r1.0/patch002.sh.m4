...
buildDate="11/04/2004 17:47:55 MST"
buildUser=bweinrau
buildHost=bld-cmbuild4
sourceCode=/local/home/bweinrau/dev/sandbox/bweinrau/perf/ChainDB/src/schema/src/source.sql
...
alter table task_namespace add (source varchar2(512));
alter table task_namespace add (type varchar2(64));
