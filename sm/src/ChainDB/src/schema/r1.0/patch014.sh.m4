...
buildDate="01/05/2005 13:34:20 MST"
buildUser=bweinrau
buildHost=bld-cmbuild4
sourceCode=/local/home/bweinrau/dev/sandbox/bweinrau/perf/ChainDB/src/schema/src/taskContextIndex.sql
...
create index task_context_task_id on task_context(task_id);
  INSERT INTO 
