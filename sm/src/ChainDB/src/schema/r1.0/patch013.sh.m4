...
buildDate="12/19/2004 16:26:19 MST"
buildUser=bweinrau
buildHost=bld-cmbuild4
sourceCode=/local/home/bweinrau/dev/sandbox/bweinrau/perf/ChainDB/src/schema/src/queued.sql
...
m4_define(states, ['new','analyzing', 'starting', 'started','running', 'succeeded','failed','recovering', 'finished','retry','error','queued'])
