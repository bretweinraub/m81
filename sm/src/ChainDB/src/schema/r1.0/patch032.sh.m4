...
buildDate="08/29/2006 17:54:10 MDT"
buildUser=bweinrau
buildHost=usbohp380-7
sourceCode=/usr/local/home/bweinrau/dev/sandbox/bweinrau/perf/r9502_dev/etl/StateMachine/ChainDB/src/schema/src/export.sql
...
alter table action add (export_filter varchar2(512))
/
