...
buildDate="02/17/2006 14:19:49 MST"
buildUser=
buildHost=
sourceCode=ChainDB/src/schema/src/waiting.sql
...
m4_define(states, ['new','analyzing', 'waiting', 'starting', 'started','running', 'succeeded','failed','recovering', 'finished','retry','error','queued','cancel','canceled'])
