...
buildDate="11/08/2004 15:04:47 MST"
buildUser=bweinrau
buildHost=bld-cmbuild4
sourceCode=/local/home/bweinrau/dev/sandbox/bweinrau/perf/ChainDB/src/schema/src/name.sql
...
alter table task modify (task_name varchar2(256));
