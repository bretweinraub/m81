...
buildDate="01/28/2005 14:26:46 MST"
buildUser=bweinrau
buildHost=bld-cmbuild4
sourceCode=/local/home/bweinrau/dev/sandbox/bweinrau/perf/ChainDB/src/schema/src/contextSummary.sql
...
-- This table does not belong in this module

m4_dnl createM80StandardTable(context_summary,
m4_dnl 		       (
m4_dnl 			LRA_FIXED_DBNAME	varchar2(32),
m4_dnl 			FLATRUNSETNAME		varchar2(256),
m4_dnl 			NUM_USERS		number
m4_dnl 			),(task),,(INSTANTIATION_TABLE=true))
m4_dnl 
