...
buildDate="11/05/2004 14:32:45 MST"
buildUser=bweinrau
buildHost=bld-cmbuild4
sourceCode=/local/home/bweinrau/dev/sandbox/bweinrau/perf/ChainDB/src/schema/src/tag.sql
...
alter table task_namespace modify (tag varchar2(128));
