...
buildDate="01/21/2005 14:44:20 MST"
buildUser=bweinrau
buildHost=bld-cmbuild4
sourceCode=/local/home/bweinrau/dev/sandbox/bweinrau/perf/ChainDB/src/schema/src/dropHierKey.sql
...
code="
alter table task_context drop constraint task_context_fk2;
