...
=head1 NAME - Metadata::Object::PollingETLManager

Metadata::Object::PollingETLManager description; stub description please expand
...
# This file was automatically generated from PollingETLManager.pm.m80 by 
# bret on ubuntu (Linux ubuntu 2.6.31-19-generic-pae #56-Ubuntu SMP Thu Jan 28 02:29:51 UTC 2010 i686 GNU/Linux)
# DO NOT EDIT THIS FILE 


package Metadata::Object::PollingETLManager;
...
Metadata::Object::PollingETLManager extends class Metadata::Object::ETLManager ; refer to the documentation for that object for member variables and methods.
...
=item Metadata::Object::PollingETLManager->new()

initializes on object of type Metadata::Object::PollingETLManager
...
sub new {
    my Metadata::Object::PollingETLManager $this = shift;

    print STDERR "in Metadata::Object::PollingETLManager::new(" . join (",", @_) . ")\n" if $ENV{DEBUG};
    Confess "Missing the value for an argument (even nulls) on creation of Metadata::Object::PollingETLManager" if scalar @_ % 2 != 0;
    ...
    foreach my $key (keys(%args)) {
        ...
        if (my $fn = $this->UNIVERSAL::can($setterName)) {  # test that the object can call this function
            ...
            Confess "Field named \"$key\" is not defined in object Metadata::Object::PollingETLManager. typo ?\n";
        }
    }


    Confess "cannot initialize object of type Metadata::Object::PollingETLManager without required member variable pollTableList"
        unless exists $this->{pollTableList};

    $this->{pollInterval} = "60" unless defined $this->{pollInterval};

    $this->{insertDateField} = "inserted_dt" unless defined $this->{insertDateField};

    Confess "cannot initialize object of type Metadata::Object::PollingETLManager without required member variable insertDateField"
        unless exists $this->{insertDateField};

    $this->{updateDateField} = "updated_dt" unless defined $this->{updateDateField};

    Confess "cannot initialize object of type Metadata::Object::PollingETLManager without required member variable updateDateField"
    ...
    eval {Metadata::Object::PollingETLManager::__new($this,%args);};

    croak $@ if $@
	and $@ !~ /^Undefined subroutine.+?Metadata::Object::PollingETLManager::__new/;
    ...
    eval {Metadata::Object::PollingETLManager::_new($this,%args);};

    croak $@ if $@
	and $@ !~ /^Undefined subroutine.+?Metadata::Object::PollingETLManager::_new/;
...
=head3 $Object::PollingETLManager->getPollTableList ()
...
=head3 $Object::PollingETLManager->setPollTableList (pollTableList => "any string"*)
...
=cut
    ...
    Confess "argument 'pollTableList' is required for Metadata::Object::PollingETLManager->setPollTableList()" unless defined $pollTableList;
...
=head3 $Object::PollingETLManager->getPollInterval ()
...
=head3 $Object::PollingETLManager->setPollInterval (pollInterval => "any string")
...
=head2 insertDateField => "any string"* (default: "inserted_dt")
...
=head3 $Object::PollingETLManager->getInsertDateField ()
...
=head3 $Object::PollingETLManager->setInsertDateField (insertDateField => "any string"*)
...
=cut
    ...
    Confess "argument 'insertDateField' is required for Metadata::Object::PollingETLManager->setInsertDateField()" unless defined $insertDateField;
...
=head2 updateDateField => "any string"* (default: "updated_dt")
...
=head3 $Object::PollingETLManager->getUpdateDateField ()
...
=head3 $Object::PollingETLManager->setUpdateDateField (updateDateField => "any string"*)
...
=cut
    ...
    Confess "argument 'updateDateField' is required for Metadata::Object::PollingETLManager->setUpdateDateField()" unless defined $updateDateField;
...
=head3 $Object::PollingETLManager->getModel ()
...
=head3 $Object::PollingETLManager->setModel (model => "any string")
...
=head3 $Object::PollingETLManager->getDebug ()
...
=head3 $Object::PollingETLManager->setDebug (debug => "any string")
...
=head3 $Object::PollingETLManager->_new ()
...
=cut
    ...
    Confess "Metadata::Object::PollingETLManager->_new requires named arguments, or maybe a non-static method is being called in a static context " if scalar @_ && scalar @_ % 2 != 0;
    my %args = @_;
