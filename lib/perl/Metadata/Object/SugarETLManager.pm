...
=head1 NAME - Metadata::Object::SugarETLManager

Metadata::Object::SugarETLManager description; stub description please expand
...
Metadata::Object::SugarETLManager extends class Metadata::Object::ETLManager ; refer to the documentation for that object for member variables and methods.

=cut

use fields qw( pollTableList pollInterval debug );
...
=item Metadata::Object::SugarETLManager->new()

initializes on object of type Metadata::Object::SugarETLManager
...
sub new {
    my Metadata::Object::SugarETLManager $this = shift;

    print STDERR "in Metadata::Object::SugarETLManager::new(" . join (",", @_) . ")\n" if $ENV{DEBUG};
    Confess "Missing the value for an argument (even nulls) on creation of Metadata::Object::SugarETLManager" if scalar @_ % 2 != 0;
    ...
    foreach my $key (keys(%args)) {
        ...
        if (my $fn = $this->UNIVERSAL::can($setterName)) {  # test that the object can call this function
            ...
            Confess "Field named \"$key\" is not defined in object Metadata::Object::SugarETLManager. typo ?\n";
        }
    }


    Confess "cannot initialize object of type Metadata::Object::SugarETLManager without required member variable pollTableList"
    ...
    eval {Metadata::Object::SugarETLManager::__new($this,%args);};

    croak $@ if $@
	and $@ !~ /^Undefined subroutine.+?Metadata::Object::SugarETLManager::__new/;
    ...
    eval {Metadata::Object::SugarETLManager::_new($this,%args);};

    croak $@ if $@
	and $@ !~ /^Undefined subroutine.+?Metadata::Object::SugarETLManager::_new/;
...
=head3 $Object::SugarETLManager->getPollTableList ()
...
=head3 $Object::SugarETLManager->setPollTableList (pollTableList => "any string"*)
...
=cut
    ...
    Confess "argument 'pollTableList' is required for Metadata::Object::SugarETLManager->setPollTableList()" unless defined $pollTableList;
...
=head3 $Object::SugarETLManager->getPollInterval ()
...
=head3 $Object::SugarETLManager->setPollInterval (pollInterval => "any string")
...
=head3 $Object::SugarETLManager->getDebug ()
...
=head3 $Object::SugarETLManager->setDebug (debug => "any string")
...
=head3 $Object::SugarETLManager->_new ()
...
=cut
    ...
    Confess "Metadata::Object::SugarETLManager->_new requires named arguments, or maybe a non-static method is being called in a static context " if scalar @_ && scalar @_ % 2 != 0;
    my %args = @_;
