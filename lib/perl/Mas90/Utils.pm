...
=head1 NAME - Mas90::Utils

Mas90::Utils description; stub description please expand
...
=item Mas90::Utils->new()

initializes on object of type Mas90::Utils
...
sub new {
    my Mas90::Utils $this = shift;

    print STDERR "in Mas90::Utils::new(" . join (",", @_) . ")\n" if $ENV{DEBUG};
    Confess "Missing the value for an argument (even nulls) on creation of Mas90::Utils" if scalar @_ % 2 != 0;
    ...
    foreach my $key (keys(%args)) {
        ...
        if (my $fn = $this->UNIVERSAL::can($setterName)) {  # test that the object can call this function
            ...
            Confess "Field named \"$key\" is not defined in object Mas90::Utils. typo ?\n";
        }
    }
    ...
    eval {Mas90::Utils::__new($this,%args);};

    croak $@ if $@
	and $@ !~ /^Undefined subroutine.+?Mas90::Utils::__new/;
    ...
    eval {Mas90::Utils::_new($this,%args);};

    croak $@ if $@
	and $@ !~ /^Undefined subroutine.+?Mas90::Utils::_new/;
...
=cut
    ...
    Confess "Mas90::Utils->_new requires named arguments, or maybe a non-static method is being called in a static context " if scalar @_ && scalar @_ % 2 != 0;
    my %args = @_;
...
=head3 $Utils->mas90tableName (data => "any string"*)

 - data ("any string")		 : data to process

convert a very long mas90 table name into something not so  lengthy

=cut

    Confess "Mas90::Utils::mas90tableName requires named arguments, or maybe a non-static method is being called in a static context " if scalar @_ && scalar @_ % 2 != 0;
    my %args = @_;
    my $data = $args{data};
    Confess "argument 'data' is required for Mas90::Utils::mas90tableName()" unless defined $data;
